return {
  ...
  -- Mason allows you to install and manage external tools like LSP servers, DAP servers, linters, and formatters.
  -- Also makes them available in Nvim's standard path.
  {
  ...
  -- ':h lspconfig-all' to see options for LSP configs.
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', 'gD', vim.lsp.buf.declaration, { desc = "LSP: Get to Declaration" })
      ...
      vim.keymap.set('n', 'K', vim.lsp.buf.hover,
        { desc = "LSP: Hover symbol information" })
      ...
      vim.keymap.set('n', '<space>rn', vim.lsp.buf.rename, { desc = "LSP: Rename symbol" })
  ...
  --         if #clients > 0 and vim.bo.filetype ~= "yaml" and vim.bo.filetype ~= "md" and vim.bo.filetype ~= "markdown" then
  --           vim.lsp.buf.format()
  --         end
  --       end
  --     })
